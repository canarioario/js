...
let persona1 = new Persona("juan", "gomez", "49113346c", 2004);
let diputado = new Diputado("Pepe", "Perez", "49113346c", 1996, "Recreativo de huelva");
let diputado2 = new Diputado("Paco", "Js", "49113346c", 1934, "Recreativo de huelva");
let partido = new Partido("Recreativo de huelva", 1996);
...
class Identidad {
    ...
    */
    static investidura(parlamento, elect) {
